 ...
 * 
 */
class Assertion : public Exceptions::Jali_exception {
public:
...
void Jali_assert(const char * cond, const char * file, unsigned int line);
...
#ifdef ENABLE_DBC
#define ASSERT(bool_expression) do { if (!(bool_expression)) DBC::Jali_assert( #bool_expression, __FILE__, __LINE__ ); } while (0)
#else
